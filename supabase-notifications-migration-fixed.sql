-- ==========================================================
-- LIFE X 通知・お知らせ機能 マイグレーションファイル (修正版)
-- ==========================================================
-- 作成日: 2025-01-21
-- 修正日: 2025-01-21
...
DROP POLICY IF EXISTS "Authenticated users can view published notifications" ON notifications;
...
-- ユーザーは自分の既読情報のみ作成可能
DROP POLICY IF EXISTS "Users can create own reads" ON notification_reads;
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Notifications Migration 完了！';
    RAISE NOTICE '========================================';
    RAISE NOTICE '';
    RAISE NOTICE '作成されたテーブル:';
    RAISE NOTICE '- notifications';
    RAISE NOTICE '- notification_reads';
    RAISE NOTICE '';
    RAISE NOTICE '次のステップ:';
    RAISE NOTICE '1. /admin-notifications.html でお知らせを作成';
    RAISE NOTICE '2. TOP画面で表示を確認';
    RAISE NOTICE '';
    RAISE NOTICE 'テストガイド: docs/notification-test-guide.md';
    RAISE NOTICE '========================================';
END $$;
